...
$sql = "SELECT * FROM funcionarioos WHERE id = '$id'";
...
<body>
    <header>
        <main class="page_edit_register_resident">
            <form action="../UPLOADS/upload56584525bd795_register_funcionario.php" method="POST">
                    ...
                    <div class="content_edit_register_resident">
                        ...
                        <div class="dice_register_resident">
                            <div class="max_input">
                                ...
                                <input type="text" name="nome_funcionario" value="<?php echo $lenderesult['nomefunc']; ?>">
                            </div>
                            <div class="min_input">
                                <label>Apartamento:</label>
                                <input type="text" name="Apartamento" value="<?php echo $lenderesult['numapartament']; ?>">
                            </div>
                            <div class="min_input">
                                <label>Documento:</label>
                                <input type="text" name="documento_funcionario"
                                    value="<?php echo $lenderesult['documentofunc']; ?>">
                            </div>
                            <div class="min_input">
                                <label>Celular do funcionário:</label>
                                <input type="text" name="Celular"
                                    value="<?php echo $lenderesult['celularfunc']; ?>">
                            </div>
                            <div class="min_input">
                                <label>Horário de trabalho:</label>
                                <input type="text" name="Horario_trabalho"
                                    value="<?php echo $lenderesult['horario']; ?>">
                            </div>
                            <div class="min_input">
                                <label>Permissão de acesso:</label>
                                <input type="text" name="Permissao"
                                    value="<?php echo $lenderesult['permicao']; ?>">
                            </div>
                            
                        </div>
                        <div class="photo_register">
                            <div class="content_photo">
                                <img src="../../Galeria/funcionarios/<?php echo $lenderesult['fotofunc']; ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" id="max_height_modal">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="../UPLOADS/upload6524525845_photo7856548_register_funcionario.php" enctype="multipart/form-data">
