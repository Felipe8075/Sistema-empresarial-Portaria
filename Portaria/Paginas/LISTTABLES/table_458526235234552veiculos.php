            ...
            <div class="wapper_content_records">
                <div class="content_records">
                    <div class="header_title_record">
                        Registros cadastrais dos funcionários
                    </div>
                        ...
                        if ( $_POST != NULL) {
                            $filtro = $_POST["filtra-busca"];
                                $filtro_sql = "WHERE id LIKE'%$filtro%'
                                    OR residencia LIKE'%$filtro%'
                                    OR cordoveiculo LIKE'%$filtro%'
                                    OR pladoveiculo LIKE'%$filtro%'
                                    OR nomeveiculo LIKE '%$filtro%'";
                        }
                    ...
                    <div class="get_table_records row">
                        <table class="table table-striped">
                            ...
                            <?php
                                    ...
                                    $Apartamento = $receberRegistros['residencia'];
                                    $Vaga = $receberRegistros['blocomorador'];
                                    $marca_veiculo = $receberRegistros['marcaveiculo'];
                                    $nome_veiculo = $receberRegistros['nomeveiculo'];
                                    $cor_veiculo = $receberRegistros['cordoveiculo'];
                                    $placa_veiculo = $receberRegistros['pladoveiculo'];
                                    $ano_veiculo = $receberRegistros['anodoveiculo'];
                                ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $ano_veiculo;?></td>
                                <td>
                                    <div class="more_button"><a
                                            href="../Records/edit_veiculos865958547_condominio45852415212.php?inviarid=<?php echo $receberRegistros['id'];?>">Editar
